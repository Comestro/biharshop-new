...
<body class="font-sans antialiased bg-gray-100">
    ...
    <!-- Sidebar -->
    <div id="sidebar"
        class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform 
    ...
    <div class="lg:pl-64 flex flex-col min-h-screen">
        ...
        <!-- Topbar -->
        <header class="bg-white border-b border-gray-200 flex items-center justify-between px-4 py-3 sticky top-0 z-30 shadow-sm">
