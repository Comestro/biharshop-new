            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between">
                <div class="flex items-center mb-4 md:mb-0">
                    ...
                    <div class="ml-6">
                        ...
                        @endif
                        <div class="mt-4">
                            <button wire:click="paymentApprove"
                                class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
                                Approve Member
                            </button>
                        </div>
                                ...
                                <tbody>
                                    @forelse ($transactions as $tx)
                                        <tr class="hover:bg-slate-50">
                                            ...
                                            <td class="px-3 py-2 border text-teal-700">₹{{ number_format($tx['amount'], 2) }}
                                            </td>
                                    ...
                                    @forelse ($withdrawals as $w)
                                        <tr class="hover:bg-slate-50">
                                            <td class="px-3 py-2 border text-red-700">
                                                ...
                                                <span class="text-xs text-slate-500 ml-1">Net:
                                                    ₹{{ number_format(($w['details']['net_amount'] ?? round($w['amount'] * 0.93, 2)), 2) }}</span>
                                            </td>
                                            <td class="px-3 py-2 border">{{ $w['status'] }}</td>
                                            <td class="px-3 py-2 border">
                                                {{ \Carbon\Carbon::parse($w['created_at'])->format('d M Y, h:i A') }}
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
