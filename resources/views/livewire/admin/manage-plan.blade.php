            ...
            <tbody>
                @forelse($plans as $plan)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-3 py-2 border font-medium text-gray-800">{{ $plan->name }}</td>
                        <td class="px-3 py-2 border text-gray-600">₹{{ number_format($plan->price, 2) }}</td>
                        <td class="px-3 py-2 border text-center">
            ...
            <div class="bg-white w-full max-w-lg rounded-lg shadow-lg overflow-y-auto max-h-full p-6 relative">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" wire:model="name" class="w-full border rounded p-2" placeholder="Plan Name">
                    ...
                    <div>
                        ...
                        <textarea wire:model="description" rows="2" class="w-full border rounded p-2"></textarea>
                    </div>

                    <div>
                        <label class="text-sm font-semibold">Features</label>
                        <textarea wire:model="features" rows="2" class="w-full border rounded p-2"></textarea>
                    </div>
