<div>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div x-show="showPositionModal"
            ...
            <div class="bg-white rounded-xl max-w-lg w-full shadow-xl" @click.away="showPositionModal = false">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Change Position for {{ $selectedMember->name }}</h3>
                    @if($selectedMember->binaryPosition)
                        <p class="mt-1 text-sm text-gray-500">Current sponsor: {{ $selectedMember->binaryPosition->parent->name }}</p>
                    @endif
                </div>
        ...
        <div x-show="showTreeModal"
             ...
             x-transition>
            @if($viewingMember)
            <div class="bg-white rounded-xl max-w-4xl w-full shadow-xl" @click.away="showTreeModal = false">
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    <h3 class="text-lg font-medium text-gray-900">Tree for {{ $viewingMember->name }}</h3>
                    <button @click="showTreeModal = false; $wire.closeTree()" class="text-gray-400 hover:text-gray-500">
