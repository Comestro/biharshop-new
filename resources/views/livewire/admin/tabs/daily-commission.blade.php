<div class="space-y-6">
    <div class="bg-gray-50 rounded-lg p-4">
        <h3 class="text-sm font-medium text-gray-900 mb-3">Daily Commission Summary</h3>
    ...
    <div class="bg-gray-50 rounded-lg p-4">
        <h3 class="text-sm font-medium text-gray-900 mb-3">Daily Commission Transactions</h3>
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm border border-gray-200 rounded-lg">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center text-gray-400 py-3">No daily commissions.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
