<div class="py-8">
    <div class="max-w-6xl mx-auto bg-white border rounded-xl shadow p-8">
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div class="border rounded-lg p-3 md:col-span-2">
                    ...
                    <div class="flex justify-between mt-1"><span class="text-gray-600">Pan No</span><span
                        ...
                        <div class="flex justify-between mt-1"><span class="text-gray-600">Login Password</span><span class="font-medium">{{ $password ?? 'Not displayed' }}</span></div>
                </div>
            </div>
        </div>
